                ...
                <>
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-12">
                      ...
                      {solution.result.specialCases && solution.result.specialCases.length > 0 && (
                        <div className="space-y-4">
                          {solution.result.specialCases.map((sc, idx) => (
                            <div key={idx} className="glass p-6 rounded-3xl border-orange-500/30 flex gap-4 items-start bg-orange-500/5">
                              ...
                              <div>
                                <h4 className="text-lg font-bold text-orange-400 mb-1">{sc.title}</h4>
                                <p className="text-slate-300 text-sm leading-relaxed">{sc.description}</p>
                              </div>
                            </div>
                          ))}
                        </div>
